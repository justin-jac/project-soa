                ...
                <div class="form">
                    ...
                    <div>
                        <center style="margin: 25px;">
                            <a href="index.php">
                                <button type="button" class="btn btn-success" style="padding: 10px;background: #41EAD4;color: #000;font-weight: 600;font-size: 1.35em;letter-spacing: 0.05em;cursor: pointer;width:100%" onclick="createStaff()">SIGN UP</button>
                            </a>
                        </center>
