...
<script>
    ...
    function createStaffRow(staff) {
        var staffRow = $("<tr id='staff-row-" + staff.id + "'></tr>");
        staffRow.append("<td>" + staff.id + "</td>");
        staffRow.append("<td><input type='text' class='email-staff' value='" + staff.email + "' disabled></td>");
        staffRow.append("<td><input type='text' class='nama-staff' value='" + staff.nama + "' disabled></td>");
        staffRow.append("<td><input type='text' class='password-staff' value='" + staff.password + "' disabled></td>");
